...
5. Persist or propose a compact state file at `ai/state/features/<feature_id>.json`.

## Package fields
Each package must include:
- `package_id`, `objective`, `acceptance_criteria`, `tasks`, `dependencies`
- `ownership_paths`, `risks`, `local_validations`, `package_gates`
...
`USER_APPROVAL -> PACKAGE_PLANNING -> PACKAGE_IMPLEMENTATION`.
