...
Ingeniería: Contrato elevado a 1.3.0 con tercer log de enmiendas B-01..B-07. Siete citas file:line corregidas y la convencion cambiada a file:simbolo. B-02: AC-08 solo tiene sentido si una dimension no reportada queda NULL -- Pi no manda cache ni reasoning en la unica muestra viva, asi que un 0 seria el cero-de-antemano que el propio AC prohibe. B-03: round-half-up no es implementable sobre el float parseado… _(truncado al render)_
