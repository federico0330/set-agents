...
| [035](035-panel-honesto-consola-y-tips/spec.md) | Panel honesto, consola partida y TIPS al día (record-review deja de saltear el panel FULL y el finding abierto; segunda pasada de extracción de routing/vault con caracterización previa; TIPS-USO + puntero desde COMO-FUNCIONA) | Approved | 2026-08-20 |
