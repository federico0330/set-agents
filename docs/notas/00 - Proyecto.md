...
- [[features/004-adaptive-dispatch|004-adaptive-dispatch]] — fase `PACKAGE_PLANNING` · paquetes 0/0
...
- **004-adaptive-dispatch** → `PACKAGE_IMPLEMENTATION` — plan next coherent package
...
_Actualizado: 2026-07-26T14:58:25+00:00_
<!-- /notas:auto -->
