...
- [[features/005-portable-harness|005-portable-harness]] — fase `PACKAGE_PLANNING` · paquetes 0/0
...
- **005-portable-harness** → `PACKAGE_IMPLEMENTATION` — plan next coherent package
...
_Actualizado: 2026-07-27T14:49:56+00:00_
<!-- /notas:auto -->
