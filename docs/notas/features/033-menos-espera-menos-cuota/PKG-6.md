...
- [ ] context pack obligatorio para entrar en PACKAGE_IMPLEMENTATION (planned)
- [ ] gate-runner rechazado cuando todos los comandos son P001: va local-gate-runner (planned)
