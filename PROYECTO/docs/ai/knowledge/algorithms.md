# Conocimiento acumulado — Algoritmos y estructuras de datos

> Memoria del "departamento" de algorithms para ESTE proyecto. La escribe SOLO `memory-scribe`,
> consolidando las secciones `## Destilado` de los reportes de reviewers/auditores; los demás agentes
> la leen al arrancar (junto con `_global/algorithms.md` si existe) y no la editan. Entradas con prefijo
